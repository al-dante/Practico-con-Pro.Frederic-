...
print("4. In math notation, leading zeros are ok, as in 02. What happens if you try this in Python? \n - leading zeros in decimal integer literals are not permitted; use an 0o prefix for octal integers")
...
minute = 60
print("\n")
print("Exercise 1.2. Start the Python interpreter and use it as a calculator. \n - ") #42minute 42second = 42.7minute, 0.77hour
